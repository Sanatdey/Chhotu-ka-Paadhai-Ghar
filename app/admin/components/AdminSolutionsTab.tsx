    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <p className="text-center text-gray-600">No solutions yet</p>
        ) : (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex-1">
                  <h3 className="font-bold text-lg text-gray-800">{solution.title}</h3>
                  <p className="text-sm text-gray-600 mt-2">
                    Subject: <span className="font-semibold">{solution.subject}</span> | 
                    Difficulty: <span className="font-semibold">{solution.difficultyLevel}</span>
                  </p>
