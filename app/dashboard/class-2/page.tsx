  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          {activeTab === "videos" && <VideosSection selectedSubject={selectedSubject} selectedDifficulty={selectedDifficulty} searchQuery={searchQuery} userClass={"class2"}/>}
          {activeTab === "solutions" && <SolutionsSection selectedSubject={selectedSubject} selectedDifficulty={selectedDifficulty} searchQuery={searchQuery} userClass={"class2"} />}
          {activeTab === "worksheet" && <WorksheetSection selectedSubject={selectedSubject} selectedDifficulty={selectedDifficulty} searchQuery={searchQuery} userClass={"class2"} />}
        </motion.div>
      </div>
